...
const craftItemData: Omit<CraftItem, "id">[] = [
  {
  ...
  //   category: "knitting",
  //   images: [],
  //   description: "It turned out a little bit too tall and narrow for most mugs. It does fit my beer glasses and Thermos bottle though, so there's that.",
  //   dateFinished: "2024-11",
  // },
  {
    ...
    dateFinished: "2024-12",
  },
  {
    title: "\"Hoot Hoot Owl\" hot water bottle cover",
    category: "knitting",
    images: [`${imgUrlBase}owl-hwb-1.jpg`, `${imgUrlBase}owl-hwb-2.jpg`],
    description: `I found a simple hot water bottle cover pattern online, and composed the owl pattern on top of it myself. Shout out to <a href="https://www.stitchfiddle.com/en" target="_blank">Stitch Fiddle</a> which I used to compose the pattern.`,
...
export const craftItems: CraftItem[] = craftItemData
